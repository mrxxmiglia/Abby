...
const handleUserProvidesA8 = async (req) => {
  ...
  let a_nine = parameters.a_nine;
  let a_ten = parameters.a_ten;
  let a_eleven = parameters.a_eleven;
  let a_twelve = parameters.a_twelve;
...
const handleLastConversation = (req) => {
  ...
  let metadata1 = [
    ...
    {
      QuestionID: "2",
      UserAnswer: parameters.a_two,
    },
    {
      QuestionID: "3",
      UserAnswer: parameters.a_three,
    },
    {
      QuestionID: "4",
      UserAnswer: parameters.a_four,
    },
    {
      QuestionID: "5",
      UserAnswer: parameters.a_five,
    },
    {
      QuestionID: "6",
      UserAnswer: parameters.a_six,
    },
    {
      QuestionID: "7",
      UserAnswer: parameters.a_seven,
    },
    {
      QuestionID: "8",
      UserAnswer: parameters.a_eight,
    },
    
    {
      QuestionID: "9",
      UserAnswer: parameters.a_nine,
    },
    
    {
      QuestionID: "10",
      UserAnswer: parameters.a_ten,
    },

    {
      QuestionID: "11",
      UserAnswer: parameters.a_eleven,
    },
    {
      QuestionID: "12",
      UserAnswer: parameters.a_twelve,
    },
    {
      QuestionID: "13",
      UserAnswer: parameters.a_thirteen,
    },
